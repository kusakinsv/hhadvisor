...
//
//@Service
//public class VacancyParserBackup {
...
//    public VacancyParserBackup(List<Vacancy> vacloc1) {
...
//        vacloc1.add(v);
//        if (i == VacancyParserBackup.icount-1) doPutListVac(vacloc1);
//    }
...
//        VacancyParserBackup.area = area;
//        VacancyParserBackup.name = name;
...
//            url = VacancyParserBackup.mainurl + "?per_page=" + 20 + "&page=" + VacancyParserBackup.round + "&text=" + VacancyParserBackup.name + "&area=" + VacancyParserBackup.area;
...
//        leftover = 0;
//        round = 0;
//        VacancyParserBackup.area = "";
//        VacancyParserBackup.name = "";
//        return unionvaclist;
//    }
//
...
//        for (int j = 0; j <= countpages; j++) {
//            if (foundItems == 0) break;
//            url = VacancyParserBackup.mainurl + "?per_page=" + 20 + "&page=" + VacancyParserBackup.round + "&area=" + VacancyParserBackup.area;
//            response = restTemplate.getForObject(url, Models.class);
//            round = j;
//            ThreadParser tp = new ThreadParser();
//            tp.run();
...
//        for (int j = 0; j <= countpages; j++) {
//            if (foundItems == 0) break;
//            url = VacancyParserBackup.mainurl + "?per_page=" + 20 + "&page=" + VacancyParserBackup.round + "&text=" + VacancyParserBackup.name;
